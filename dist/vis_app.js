...
/***/ function(module, exports, __webpack_require__) {
	...
	var visApp = {
	  ...
	  repeat: function repeat(what, count) {
	    return _.repeat(what, count);
	  },
	  takeEvenAndMultiply: function takeEvenAndMultiply(arr, by) {
	    return _(arr).filter(function (i) {
	      return i % 2 === 0;
	    }).map(function (i) {
	      return i * by;
	    }).value();
...
;
//# sourceMappingURL=vis_app.js.map